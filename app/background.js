...
if (isProd) electron_serve__WEBPACK_IMPORTED_MODULE_1___default()({
  directory: "app"
});else electron__WEBPACK_IMPORTED_MODULE_0__.app.setPath("userData", `${electron__WEBPACK_IMPORTED_MODULE_0__.app.getPath("userData")} (development)`);
let mainWindow;
electron__WEBPACK_IMPORTED_MODULE_0__.app.on("ready", () => {
  mainWindow = (0,_helpers__WEBPACK_IMPORTED_MODULE_2__.createWindow)("main", {
    width: 770,
    height: 720,
    minWidth: 770,
    minHeight: 720,
...
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.setMaxListeners(5);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VALID_EXTENSIONS": () => (/* binding */ VALID_EXTENSIONS),
/* harmony export */   "VALID_TYPES": () => (/* binding */ VALID_TYPES)
/* harmony export */ });
const VALID_EXTENSIONS = [// images
"jpeg", "jpg", "png", "gif", "tiff", "bmp", "webp", "jp2", "avif", "heif", // raw
"3fr", "ari", "arw", "bay", "braw", "crw", "cr2", "cr3", "cap", "data", "dcs", "dcr", "dng", "drf", "eip", "erf", "fff", "gpr", "iiq", "k25", "kdc", "mdc", "mef", "mos", "mrw", "nef", "nrw", "obm", "orf", "pef", "ptx", "pxn", "r3d", "raf", "raw", "rwl", "rw2", "rwz", "sr2", "srf", "srw", "tif", "x3f", // video
"webm", "mkv", "flv", "vob", "ogv", "ogg", "drc", "gifv", "mng", "avi", "mts", "m2ts", "ts", "mov", "qt", "wmv", "yuv", "rm", "rmvb", "viv", "asf", "amv", "mp4", "m4p", "m4v", "mpg", "mp2", "mpeg", "mpe", "mpv", "m2v", "svi", "3gp", "3g2", "mxf", "roq", "nsv", "f4v", "f4p", "f4a", "f4b"];
const VALID_TYPES = {
  images: ["jpeg", "jpg", "png", "gif", "tiff", "bmp", "webp", "jp2", "avif", "heif"],
  raw: ["3fr", "ari", "arw", "bay", "braw", "crw", "cr2", "cr3", "cap", "data", "dcs", "dcr", "dng", "drf", "eip", "erf", "fff", "gpr", "iiq", "k25", "kdc", "mdc", "mef", "mos", "mrw", "nef", "nrw", "obm", "orf", "pef", "ptx", "pxn", "r3d", "raf", "raw", "rwl", "rw2", "rwz", "sr2", "srf", "srw", "tif", "x3f"],
  video: ["webm", "mkv", "flv", "vob", "ogv", "ogg", "drc", "gifv", "mng", "avi", "mts", "m2ts", "ts", "mov", "qt", "wmv", "yuv", "rm", "rmvb", "viv", "asf", "amv", "mp4", "m4p", "m4v", "mpg", "mp2", "mpeg", "mpe", "mpv", "m2v", "svi", "3gp", "3g2", "mxf", "roq", "nsv", "f4v", "f4p", "f4a", "f4b"]
};

/***/ }),

/***/ "./main/helpers/acceptFiles.js":
/*!*************************************!*\
  !*** ./main/helpers/acceptFiles.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/instance/replace-all */ "./node_modules/@babel/runtime-corejs3/core-js/instance/replace-all.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _compress__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./compress */ "./main/helpers/compress/index.js");
...
const acceptFiles = (filePaths, basePath) => {
  ...
  const settings = (0,_compress__WEBPACK_IMPORTED_MODULE_8__.getSettings)();

  let files = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_0___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_1___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_0___default()(filePaths).call(filePaths, file => {
    let stats;
    let lstat;

    try {
      stats = fs__WEBPACK_IMPORTED_MODULE_5___default().statSync(file);
      lstat = fs__WEBPACK_IMPORTED_MODULE_5___default().lstatSync(file);
    } catch (e) {
      return false;
    }

    let isDir = stats.isDirectory();
    if (!isDir) return file;else return false;
  })).call(_context2, file => {
    var _context3, _context4, _context5, _context6;

    let name = path__WEBPACK_IMPORTED_MODULE_6___default().basename(file);
    let original_ext = path__WEBPACK_IMPORTED_MODULE_6___default().extname(file);
    let ext = original_ext.toLowerCase().replace(".", "");
    let name_without_ext = name.replace(original_ext, "");
    let isImage = _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_2___default()(_context3 = _config__WEBPACK_IMPORTED_MODULE_7__.VALID_TYPES.images).call(_context3, ext) ? "image" : false;
    let isRaw = _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_2___default()(_context4 = _config__WEBPACK_IMPORTED_MODULE_7__.VALID_TYPES.raw).call(_context4, ext) ? "raw" : false;
    let isVideo = _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_2___default()(_context5 = _config__WEBPACK_IMPORTED_MODULE_7__.VALID_TYPES.video).call(_context5, ext) ? "video" : false;
    ...
    if (mediaType === "image") {} else if (mediaType === "raw") {
      ext = settings.convert.raw; // ext = original_ext.replace(".", "");
    } else if (mediaType === "video" && settings.convert.video) {
      ext = settings.convert.video;
    }

    let fileDir = _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_3___default()(_context6 = file // remove base path from full string
    .replace(basePath, "") // remove name from string
    .replace(name, "") // remove last back slash from string
    ).call(_context6, 0, -1);

    let outputDir = replaceAll(`${settings.outputDir}/${fileDir ? fileDir + "/" : ""}`, " ", "");
    let outputPath = replaceAll(`${outputDir}${name_without_ext}.${ext}`, " ", "");
    return {
      original_path: file,
      name,
      name_without_ext,
      ...
      mediaType,
      fileDir,
      outputPath: _babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_4___default()(outputPath).call(outputPath, " ", ""),
      outputDir: _babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_4___default()(outputDir).call(outputDir, " ", "")
    };
  })).call(_context, file => file);

  return files;
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (acceptFiles);

/***/ }),

/***/ "./main/helpers/compress/compressImage.js":
/*!************************************************!*\
  !*** ./main/helpers/compress/compressImage.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var buffer_image_size__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! buffer-image-size */ "buffer-image-size");
/* harmony import */ var buffer_image_size__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(buffer_image_size__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! dayjs */ "dayjs");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _getSettings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getSettings */ "./main/helpers/compress/getSettings.js");
...
const compressImage = async (file, eventEmitter) => {
  ...
  const width = buffer_image_size__WEBPACK_IMPORTED_MODULE_2___default()(buffer).width;
  let settings = (0,_getSettings__WEBPACK_IMPORTED_MODULE_4__["default"])();
  const resize = settings.resize.image ? {
    width: width > settings.resize.image ? settings.resize.image : width
  } : {};
  let res = sharp__WEBPACK_IMPORTED_MODULE_1___default()(buffer).resize(resize);

  if (file.ext === "jpeg" || file.ext === "jpg") {
    res = res.jpeg({
      quality: settings.quality.image.jpeg
    });
  }

  if (file.ext === "png") {
    res = res.png({
      quality: settings.quality.image.png
    });
  }

  if (file.ext === "tiff") {
    res = res.tiff({
      quality: settings.quality.image.tiff
    });
  }

  res = await res.withMetadata().toFile(file.outputPath, {
    withMetadata: true
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compressImage);

/***/ }),

/***/ "./main/helpers/compress/compressRaw.js":
/*!**********************************************!*\
  !*** ./main/helpers/compress/compressRaw.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/instance/replace-all */ "./node_modules/@babel/runtime-corejs3/core-js/instance/replace-all.js");
...
/* harmony import */ var buffer_image_size__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! buffer-image-size */ "buffer-image-size");
/* harmony import */ var buffer_image_size__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(buffer_image_size__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _getSettings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./getSettings */ "./main/helpers/compress/getSettings.js");
...
const dcrawpath = __webpack_require__(/*! dcrawjs-darwin */ "dcrawjs-darwin"); // var dcrawpath
...
const compressRaw = async (file, eventEmitter, log) => {
  let settings = (0,_getSettings__WEBPACK_IMPORTED_MODULE_7__["default"])();
  const filepath = file.original_path; // const buf = new Uint8Array(fs.readFileSync(filepath));

  const buf = fs__WEBPACK_IMPORTED_MODULE_3___default().readFileSync(filepath);

  try {
    await new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default())(function (resolve, reject) {
      try {
        ...
        sh.on("close", () => {
          resolve(_babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(Buffer).call(Buffer, chunks));
        });
      } catch (err) {
        console.log(err);
        reject(err);
    ...
    const thumbnail_path = file.original_path.replace(file.original_ext, ".thumb.jpg");
    const thumbnail_buffer = await fs__WEBPACK_IMPORTED_MODULE_3___default().promises.readFile(thumbnail_path);
    const thumbnail_width = buffer_image_size__WEBPACK_IMPORTED_MODULE_4___default()(thumbnail_buffer).width;
    const resize = settings.resize.raw ? {
      width: thumbnail_width > settings.resize.raw ? settings.resize.raw : width
    } : {}; // let res = await sharp(thumbnail_buffer)
    //   .toFile(file.outputPath)
    //   .then(console.log)
    //   .catch(console.log);

    let res = sharp__WEBPACK_IMPORTED_MODULE_5___default()(thumbnail_buffer).resize(resize);

    if (settings.convert.raw === "jpeg") {
      res = res.jpeg({
        quality: settings.quality.raw
      });
    ...
    eventEmitter.send("file-progress", {
      ...
      time: dayjs__WEBPACK_IMPORTED_MODULE_6___default()()
    });
    fs__WEBPACK_IMPORTED_MODULE_3___default().unlinkSync(thumbnail_path);
    if (res) return true;else return false;
  } catch (e) {
    var _context;

    log.warn(e, `NAME=${file.name} - PATH=${file.original_path}`);
    let newPath = `${file.outputDir}${_babel_runtime_corejs3_core_js_instance_replace_all__WEBPACK_IMPORTED_MODULE_2___default()(_context = file.name_without_ext).call(_context, " ", "")}-untouched${file.original_ext}`;
    fs__WEBPACK_IMPORTED_MODULE_3___default().writeFileSync(newPath, buf);
  }
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compressRaw);

/***/ }),

/***/ "./main/helpers/compress/compressVideo.js":
/*!************************************************!*\
  !*** ./main/helpers/compress/compressVideo.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var handbrake_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! handbrake-js */ "handbrake-js");
/* harmony import */ var handbrake_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(handbrake_js__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _getSettings__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./getSettings */ "./main/helpers/compress/getSettings.js");
...
const compressVideo = async (file, eventEmitter) => {
  const filepath = file.original_path;
  let settings = (0,_getSettings__WEBPACK_IMPORTED_MODULE_13__["default"])();
  ...
  return await new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_9___default())((resolve, reject) => {
    let handbrake = handbrake_js__WEBPACK_IMPORTED_MODULE_12___default().spawn(options);
    handbrake.on("error", err => {
      reject(err); // invalid user input, no video found etc
    }).on("progress", progress => {
      eventEmitter.send("file-progress", {
        filename: file.name_without_ext + file.original_ext.toLowerCase(),
        type: "Video",
        percent: progress.percentComplete,
        time: dayjs__WEBPACK_IMPORTED_MODULE_10___default()(),
        eta: progress.eta
      });
    }).on("complete", () => {
      resolve();
    });
    electron__WEBPACK_IMPORTED_MODULE_11__.ipcMain.on("stop", () => handbrake.cancel());
    return handbrake;
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compressVideo);

/***/ }),

/***/ "./main/helpers/compress/getSettings.js":
/*!**********************************************!*\
  !*** ./main/helpers/compress/getSettings.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _renderer_contants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../renderer/contants */ "./renderer/contants.js");

const store = new (electron_store__WEBPACK_IMPORTED_MODULE_0___default())();

const getSetting = obj => {
  let stored = store.get(obj.NAME);

  if (typeof stored === "boolean") {
    if (`${stored}` === `false`) return false;else if (stored) return stored;else return obj.DEFAULT;
  } else {
...
const getSettings = () => {
  // output directory
  const outputDir = getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.OUTPUT.DIR); // if the media type will be compressed

  const isEnabled = {
    image: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.ENABLED),
    raw: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.RAW.ENABLED),
    video: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.ENABLED)
  }; // decide the quality

  const quality = {
    image: {
      jpeg: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.QUALITY.JPEG),
      png: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.QUALITY.PNG),
      gif: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.QUALITY.GIF),
      tiff: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.QUALITY.TIFF)
    },
    raw: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.RAW.QUALITY),
    video: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.QUALITY)
  }; // format type (extension)

  const convert = {
    raw: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.RAW.CONVERT_TO),
    video: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.CONVERT.ENABLED) && getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.CONVERT.TO)
  };
  const video_preset = getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.PRESET) === "None" ? false : getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.PRESET);
  const video_bitrate = getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.VIDEO.BITRATE);
  const resize = {
    raw: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.RAW.RESIZE.ENABLED) && getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.RAW.RESIZE.MAX_WIDTH),
    image: getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.RESIZE.ENABLED) && getSetting(_renderer_contants__WEBPACK_IMPORTED_MODULE_1__.SETTINGS.IMAGE.RESIZE.MAX_WIDTH)
  };
  return {
    outputDir,
    isEnabled,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getSettings);

/***/ }),

/***/ "./main/helpers/compress/index.js":
/*!****************************************!*\
  !*** ./main/helpers/compress/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getSettings": () => (/* reexport safe */ _getSettings__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "compressVideo": () => (/* reexport safe */ _compressVideo__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "compressImage": () => (/* reexport safe */ _compressImage__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   "compressRaw": () => (/* reexport safe */ _compressRaw__WEBPACK_IMPORTED_MODULE_3__["default"])
/* harmony export */ });
/* harmony import */ var _getSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getSettings */ "./main/helpers/compress/getSettings.js");
/* harmony import */ var _compressVideo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./compressVideo */ "./main/helpers/compress/compressVideo.js");
/* harmony import */ var _compressImage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./compressImage */ "./main/helpers/compress/compressImage.js");
/* harmony import */ var _compressRaw__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./compressRaw */ "./main/helpers/compress/compressRaw.js");
...
function createWindow(windowName, options) {
  ...
  win = new electron__WEBPACK_IMPORTED_MODULE_11__.BrowserWindow(_objectSpread(_objectSpread(_objectSpread({}, options), state), {}, {
    ...
    webPreferences: _objectSpread({
      ...
      preload: path__WEBPACK_IMPORTED_MODULE_13___default().join(__dirname, "/preload.js")
  ...
  __webpack_require__(/*! @electron/remote/main */ "./node_modules/@electron/remote/main/index.js").enable(win.webContents);
...
const formatBytes = (bytes, decimals = 2) => {
  ...
  return _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_0___default()((bytes / Math.pow(k, i)).toFixed(dm)) + " " + sizes[i];
};

const getFileSize = file => {
  let stats = fs__WEBPACK_IMPORTED_MODULE_1___default().statSync(file);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getFileSize);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getFileSize": () => (/* reexport safe */ _getFileSize__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "createWindow": () => (/* reexport safe */ _createWindow__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "startCompressing": () => (/* reexport safe */ _startCompressing__WEBPACK_IMPORTED_MODULE_2__["default"])
/* harmony export */ });
/* harmony import */ var _createWindow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createWindow */ "./main/helpers/createWindow.js");
/* harmony import */ var _getFileSize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getFileSize */ "./main/helpers/getFileSize.js");
/* harmony import */ var _startCompressing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./startCompressing */ "./main/helpers/startCompressing.js");
...
/***/ "./main/helpers/startCompressing.js":
/*!******************************************!*\
  !*** ./main/helpers/startCompressing.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _supercharge_promise_pool__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @supercharge/promise-pool */ "@supercharge/promise-pool");
/* harmony import */ var _supercharge_promise_pool__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_supercharge_promise_pool__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! fs */ "fs");
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _compress__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./compress */ "./main/helpers/compress/index.js");
/* harmony import */ var _acceptFiles__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./acceptFiles */ "./main/helpers/acceptFiles.js");
/* harmony import */ var _background__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../background */ "./main/background.js");
/* harmony import */ var npmlog__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! npmlog */ "npmlog");
/* harmony import */ var npmlog__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(npmlog__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var npmlog_file__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! npmlog-file */ "npmlog-file");
/* harmony import */ var npmlog_file__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(npmlog_file__WEBPACK_IMPORTED_MODULE_11__);
...
const sharedStart = array => {
  ...
  let A = _babel_runtime_corejs3_core_js_stable_instance_sort__WEBPACK_IMPORTED_MODULE_0___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(array).call(array)).call(_context),
      a1 = A[0],
      a2 = A[A.length - 1],
      L = a1.length,
      i = 0;
...
const startCompressing = async (event, filePaths = []) => {
  let eventEmitter = _background__WEBPACK_IMPORTED_MODULE_9__.mainWindow.webContents; // return if no files
  ...
  if (!stop) {
    electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on("stop", () => {
      stop = true;
  ...
  const settings = (0,_compress__WEBPACK_IMPORTED_MODULE_7__.getSettings)();
  let basePath = sharedStart(filePaths);
  let files = (0,_acceptFiles__WEBPACK_IMPORTED_MODULE_8__["default"])(filePaths, basePath);
  let total = files.length;
  let success = 0;
  let start = dayjs__WEBPACK_IMPORTED_MODULE_4___default()();
  npmlog__WEBPACK_IMPORTED_MODULE_10___default().info("started", "datetime: %j", start.format("DD/MM/YYYY HH:mm:ss"));
  eventEmitter.send("progress-started", {
    time: start.format("YYYY-MM-DD HH:mm:ss")
  }); // create output dir

  if (!fs__WEBPACK_IMPORTED_MODULE_6___default().existsSync(settings.outputDir)) {
    fs__WEBPACK_IMPORTED_MODULE_6___default().mkdirSync(settings.outputDir);
  }

  const {
    results,
    errors
  } = await _supercharge_promise_pool__WEBPACK_IMPORTED_MODULE_5___default().withConcurrency(10).for(files).handleError(async (error, file) => {
    npmlog__WEBPACK_IMPORTED_MODULE_10___default().warn(error, `NAME=${file.name} - PATH=${file.original_path}`);
    ...
    if (!fs__WEBPACK_IMPORTED_MODULE_6___default().existsSync(file.outputDir)) {
      fs__WEBPACK_IMPORTED_MODULE_6___default().mkdirSync(file.outputDir, {
        recursive: true
      });
    }

    if (file.mediaType === "image") {
      await (0,_compress__WEBPACK_IMPORTED_MODULE_7__.compressImage)(file, eventEmitter);
    } else if (file.mediaType === "video") {
      await (0,_compress__WEBPACK_IMPORTED_MODULE_7__.compressVideo)(file, eventEmitter);
    } else if (file.mediaType === "raw") {
      await (0,_compress__WEBPACK_IMPORTED_MODULE_7__.compressRaw)(file, eventEmitter, (npmlog__WEBPACK_IMPORTED_MODULE_10___default()));
    } else {
      npmlog__WEBPACK_IMPORTED_MODULE_10___default().warn("mediatype", "invalid media type: %j", file.mediaType);
    }
  ...
  stop = false;
  let end = dayjs__WEBPACK_IMPORTED_MODULE_4___default()();
  let diff = end.diff(start, "seconds");
  npmlog__WEBPACK_IMPORTED_MODULE_10___default().info("success rate", "%j files out of %j files are success", success, total);
  npmlog__WEBPACK_IMPORTED_MODULE_10___default().info("finished", "took: %j seconds", diff);

  if (isProd) {
    npmlog_file__WEBPACK_IMPORTED_MODULE_11___default().write((npmlog__WEBPACK_IMPORTED_MODULE_10___default()), settings.outputDir + "/log.txt");
  } else {
    npmlog_file__WEBPACK_IMPORTED_MODULE_11___default().write((npmlog__WEBPACK_IMPORTED_MODULE_10___default()), "logs/log-" + end.format("YYYY-MM-DDHH:mm:ss") + ".txt");
  }
...
electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on("start", startCompressing);
...
/***/ "dcrawjs-darwin":
/*!*********************************!*\
  !*** external "dcrawjs-darwin" ***!
  \*********************************/
/***/ ((module) => {

"use strict";
module.exports = require("dcrawjs-darwin");
