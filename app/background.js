...
/* harmony export */   "decideQuality": () => (/* binding */ decideQuality)
/* harmony export */ });
...
/* harmony import */ var buffer_image_size__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! buffer-image-size */ "buffer-image-size");
/* harmony import */ var buffer_image_size__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(buffer_image_size__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var sharp__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! sharp */ "sharp");
/* harmony import */ var sharp__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(sharp__WEBPACK_IMPORTED_MODULE_7__);
...
const expressApp = express__WEBPACK_IMPORTED_MODULE_4___default()();
const upload = multer__WEBPACK_IMPORTED_MODULE_8___default()();
...
expressApp.use(cors__WEBPACK_IMPORTED_MODULE_10___default()(corsOptions));
expressApp.post("/compress", upload.single("images"), async (req, response, next) => {
  try {
    let start = dayjs__WEBPACK_IMPORTED_MODULE_9___default()(); // const file = req.files[0];
    ...
    const dimensions = buffer_image_size__WEBPACK_IMPORTED_MODULE_6___default()(buffer);
    const image = {
    ...
    const res = await sharp__WEBPACK_IMPORTED_MODULE_7___default()(image.buffer).resize({
      width: image.width > 1920 ? 1920 : image.width
    }).jpeg({
      quality: image.quality
    }).toBuffer({
      resolveWithObject: true
    }).then(compressed => compressed).catch(err => {
      console.log(err);
    });
    const base64String = toBase64(res.data);
    res.base64 = base64String;
    res.originalname = file.originalname;
    res.name = path__WEBPACK_IMPORTED_MODULE_5___default().parse(image.name).name;
    ...
    let end = dayjs__WEBPACK_IMPORTED_MODULE_9___default()();
